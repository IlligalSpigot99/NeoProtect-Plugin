...
public class NettyChannelInitializer1_9_R2 extends ChannelInitializer<SocketChannel> {

	
	private ChannelInitializer<SocketChannel> oldChildHandler;
	private Method oldChildHandlerMethod;
	
	public NettyChannelInitializer1_9_R2(ChannelInitializer<SocketChannel> oldChildHandler) throws Exception {
