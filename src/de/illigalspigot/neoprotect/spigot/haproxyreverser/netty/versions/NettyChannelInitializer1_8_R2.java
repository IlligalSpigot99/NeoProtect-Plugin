...
public class NettyChannelInitializer1_8_R2 extends ChannelInitializer<SocketChannel> {

	
	private ChannelInitializer<SocketChannel> oldChildHandler;
	private Method oldChildHandlerMethod;
	
	public NettyChannelInitializer1_8_R2(ChannelInitializer<SocketChannel> oldChildHandler) throws Exception {
