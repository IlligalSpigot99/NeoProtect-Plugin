...
public class NettyChannelInitializer1_11_R1 extends ChannelInitializer<SocketChannel> {

	
	private ChannelInitializer<SocketChannel> oldChildHandler;
	private Method oldChildHandlerMethod;
	
	public NettyChannelInitializer1_11_R1(ChannelInitializer<SocketChannel> oldChildHandler) throws Exception {
