...
public class NettyChannelInitializer1_8_R3 extends ChannelInitializer<SocketChannel> {

	
	private ChannelInitializer<SocketChannel> oldChildHandler;
	private Method oldChildHandlerMethod;
	
	public NettyChannelInitializer1_8_R3(ChannelInitializer<SocketChannel> oldChildHandler) throws Exception {
