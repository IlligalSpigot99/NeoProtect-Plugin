...
public class NettyChannelInitializer1_15_R1 extends ChannelInitializer<SocketChannel> {

	
	private ChannelInitializer<SocketChannel> oldChildHandler;
	private Method oldChildHandlerMethod;
	
	public NettyChannelInitializer1_15_R1(ChannelInitializer<SocketChannel> oldChildHandler) throws Exception {
